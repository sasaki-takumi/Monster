<?php
	...
	echo $this->Form->hidden('location',array('value' => 'iwate'));
	...
	echo "<h1>よろず姫と大蛇</h1><br />";

	if (isset($result[0]['Monsteruser']['iwate'])) {
		echo '<div class="grow pic">'.$this->Html->image('yorujuhime&daija_iwate.png').'</div>'.'<br />';
	}else {
		echo '<div class="grow pic">'.$this->Html->image('m_hime&hebi.png').'</div>'.'<br />';
	}
