<?php
	...
	echo $this->Form->hidden('location',array('value' => 'sizukuishi'));
	...
	if (isset($result[0]['Monsteruser']['sizukuishi'])) {
		echo '<div class="grow pic">'.$this->Html->image('unagiotoko_sizukuisi.png').'</div>'.'<br />';
	}else {
		echo '<div class="grow pic">'.$this->Html->image('m_unagiotoko.png').'</div>'.'<br />';
	}
