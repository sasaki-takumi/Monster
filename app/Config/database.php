...
class DATABASE_CONFIG {
	...
	var $twitter = array(
        ...
        'oauth_consumer_key'    => 'ZwsDEka6WOGmD0T2xOkuw',
        'oauth_consumer_secret' => 'dpynGGFRDPuT7zpYHHSQqJ5kDOGMp8txuDvxfJRtc',
        'oauth_callback'    => '/monsters/tw_callback',
    );
}
